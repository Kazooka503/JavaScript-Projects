...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hodl the first operand for any expressions, we set it to null for now
    First_Operand: null,
...
function Input_Decimal(dot) {
    //this ensures that accidential click of the decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    // checks if an operator already exists and if Wait_Second_Operand is ture,
    ...
    // if operator already exists, property lookup is preformed for the operator
    // in the Platform_Calculation object and the funcitno that matches the
...
// this funciton updates teh screen with the contents of Display_value
function Update_Disiplay() {
...
keys.addEventListener('click', (event) => {
    ...
    // ensures that AC clears teh numbers from the Calcultaor
